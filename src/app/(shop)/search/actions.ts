...
export async function getMoreProducts(page: number, params: { q?: string; category?: string; min?: string; max?: string; sort?: string }) {
  ...
  // Apply Filters (Must match the main page logic)
